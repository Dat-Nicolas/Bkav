...
export const LOCALE_MESSAGE_IDS = createKeyLocalMessageT({
  ...
  password_length_required: "password_length_required",
...
> = {
  [LOCALES.ENGLISH]: {
    ...
    password_length_required: "Password must be at least 6 characters long!",
  ...
  [LOCALES.VIETNAM]: {
    ...
    password_length_required: "Mật khẩu phải có ít nhất 6 ký tự!",
